...
public class TwitterAuthSAXHandler extends DefaultHandler {
	...
	private static final String			XMLEL_ATKEY		= "accesstoken";
	private static final String			XMLEL_ATSEC		= "accesstokensecret";
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		...
		if (qName.equalsIgnoreCase(XMLEL_ATKEY)) {
			isAK = true;
		}

		if (qName.equalsIgnoreCase(XMLEL_ATSEC)) {
			isAS = true;
		}
	...
	public void characters(char ch[], int start, int length) throws SAXException {
		...
		if (isAK) {
			...
			System.out.println(XMLEL_ATKEY.toUpperCase() + " : " + apiKey);
			isAK = false;
		}

		if (isAS) {
			apiSecret = new String(ch, start, length);
			System.out.println(XMLEL_ATSEC.toUpperCase() + " : " + apiSecret);
			isAS = false;
		}
